...
sudo mysql -e "CREATE DATABASE thebestproject /*\!40100 DEFAULT CHARACTER SET utf8 */;"
...
# build thebestproject-tmp project
sudo mkdir /var/www/thebestproject-tmp
sudo mkdir /var/www/thebestproject-tmp/public
sudo mkdir /var/www/thebestproject-tmp/public/files
sudo mkdir /var/www/thebestproject-tmp/public/build

# Debugger
sudo mv -f /tmp/xdebug.ini /etc/php/7.3/mods-available/
sudo touch /var/www/thebestproject-tmp/var/log/xdebug.log

# OpenSSL
#cd /var/www/thebestproject-tmp || return
#sudo openssl genrsa -out thebestproject-tmp.key 2048
#sudo openssl req -new -x509 -key thebestproject-tmp.key -out thebestproject-tmp.cert -days 3650 -subj /CN=thebestproject-tmp
#sudo sed -i '/^        DocumentRoot.*/a\ \ \ \ \ \ \ \ \SSLEngine on' /etc/apache2/sites-available/thebestproject-tmp.conf
sudo mv /tmp/thebestproject-tmp.cert /var/www/thebestproject-tmp
sudo mv /tmp/thebestproject-tmp.key /var/www/thebestproject-tmp
sudo mv /tmp/.env.local /var/www/thebestproject-tmp

# good rights
sudo chgrp -R www-data /var/www/thebestproject-tmp
sudo chown -R www-data /var/www/thebestproject-tmp
sudo chmod -R 777 /var/www/thebestproject-tmp

sudo mv /tmp/thebestproject-tmp.conf /etc/apache2/sites-available
sudo a2ensite thebestproject-tmp
...
sudo sed -i '/ServerRoot "\/etc\/apache2"/a \\nServerName 90.90.90.100' /etc/apache2/apache2.conf
...
sudo chmod 0777 /var/www/thebestproject-tmp
